...
public class ModuleCommonXsdStyleCompliancyTest extends XsdStyleCompliancyTest {

    @Override
    protected String getXsdLocation() {
        return "/com/programyourhome/config/server/xsd/modules/program-your-home-config-common.xsd";
    }
